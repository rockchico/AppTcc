...
(function(window, undefined) {
   ...
   */
  tracking.initUserMedia_orig = function(element, opt_options) {
  ...
  /*
  *
  * francisco 27/03/2017: mudei a propriedade video, para pode pegar a camera traseira
  *
  *
  * */

    // f3d4889e1caad1ef6c6cfce6ee9a89df1a006ec2f1b70b90d8ba21657c39da81
    // 0dbcc35221ffd40cb0d5eb6024f427f9b50da577a838739d963529ae71cfda8f
    // f3d4889e1caad1ef6c6cfce6ee9a89df1a006ec2f1b70b90d8ba21657c39da81
    // fcb7f007a4e76c1c3f6f167f0d544db9705987991eba066f769247d27ff9ab25
    // 0dbcc35221ffd40cb0d5eb6024f427f9b50da577a838739d963529ae71cfda8f
    tracking.initUserMedia_ = function(element, opt_options) {
                ...
                devices.forEach(function(device) {
                  ...
                  if(device.kind === 'videoinput') {
                        ...
                        if(videoDeviceIndex == 1) {
                            rearVideoInputId = device.deviceId;
                            console.log("opa Devices: "+device.kind + ": " + device.label + " id = " + device.id);
                        }
      ...
      navigator.getUserMedia({
            video: {
                ...
                //deviceId: {exact: rearVideoInputId},
                width: {exact: 320},
                height: {exact: 240},
                //optional: [{sourceId: rearVideoInputId}]
                facingMode: {exact: 'environment'}
            },
                audio: false
            }, function(stream) {
  ...
  tracking.trackCanvasInternal_ = function(element, tracker) {
    ...
    var imageData = tracking.context.getImageData(0, 0, width, height);
  ...
  tracking.trackVideo_ = function(element, tracker) {
    ...
    tracking.context = canvas.getContext('2d');
    var width;
    var height;
        ...
        if (element.readyState === element.HAVE_ENOUGH_DATA) {
          try {
            ...
            // hence keep trying to read it until resolved.
              tracking.context.drawImage(element, 0, 0, width, height);
          } catch (err) {}
          tracking.trackCanvasInternal_(canvas, tracker);
        }
